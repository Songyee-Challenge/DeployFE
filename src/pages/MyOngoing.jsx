...
const MyOngoing = () => {
  ...
  const getRecruit = () => {
    axios
      .get("http://43.200.19.7:8080/api/v1/mypage/challenge/recruiting", {
        headers: {
          "Content-Type": "application/json",
          Authorization: ` Bearer ${ACCESS_TOKEN}`,
        },
  ...
  const getInprocess = () => {
    axios
      .get("http://43.200.19.7:8080/api/v1/mypage/challenge/inprocess", {
        headers: {
          "Content-Type": "application/json",
          Authorization: ` Bearer ${ACCESS_TOKEN}`,
        },
  ...
  const getFinished = () => {
    axios
      .get("http://43.200.19.7:8080/api/v1/mypage/challenge/finished", {
        headers: {
          "Content-Type": "application/json",
          Authorization: ` Bearer ${ACCESS_TOKEN}`,
        },
