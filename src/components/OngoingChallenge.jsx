...
const OngoingChallenge = () => {
    ...
    const getOngoing = () => {
        axios.get('http://43.200.19.7:8080/api/v1/challenge/inprocess',  {
            headers: {
           ...
           {ongoing && ongoing.map(challenge => (
            <div>
                <OngoingImageContainer onClick={handleImageClick}>
                    <OngoingImage id={challenge.challenge_id} src={`http://43.200.19.7:8080/api/v1/picture?pictureName=${challenge.picture}`}/>
